...
const accordionItemHeaders = document.querySelectorAll(".q__t-b-wrapper")
...
accordionItemHeaders.forEach(accordionItemHeader => {
  accordionItemHeader.addEventListener("click", event => {
    ...
    const currentlyActiveAccordionItemHeader = document.querySelector(".q__t-b-wrapper.active")
    if(currentlyActiveAccordionItemHeader && currentlyActiveAccordionItemHeader!==accordionItemHeader) {
      currentlyActiveAccordionItemHeader.classList.toggle("active")
      currentlyActiveAccordionItemHeader.nextElementSibling.style.maxHeight = 0
      currentlyActiveAccordionItemHeader.parentElement.style.backgroundColor = "#FFF"
      currentlyActiveAccordionItemHeader.parentElement.style.color = "#000"
      currentlyActiveAccordionItemHeader.children[1].style.backgroundColor = "#F9025D"
      currentlyActiveAccordionItemHeader.children[1].children[0].setAttribute("src", plus)
    }
    ...
    if(accordionItemHeader.classList.contains("active")) {
      ...
      accordionItemHeader.parentElement.style.backgroundColor = "#F9025D"
      accordionItemHeader.parentElement.style.color = "#FFF"
      accordionItemHeader.children[1].style.backgroundColor = "#FFF"
      accordionItemHeader.children[1].children[0].setAttribute("src", minus)
    }
    else {
      accordionItemHeader.parentElement.style.backgroundColor = "#FFF"
      accordionItemHeader.parentElement.style.color = "#000"
      accordionItemHeader.children[1].style.backgroundColor = "#F9025D"
      accordionItemHeader.children[1].children[0].setAttribute("src", plus)
...
const slider = (function(){
	...
	function _createControls(dots = false, buttons = false) {
		...
		function createArrows() {
			...
			leftArrow = createHTMLElement("div", "prev-arrow d-none");
			...
			// SVG function
			function createSVG(dValue, color="#fff") {
...
document.querySelectorAll('.whitePaper-btn')[0].addEventListener('click', function (e) {
	navigator.clipboard
		.writeText("0xf82f0c7fca2a0687b177e55bb92e1017e5369fe3")
		.then(
			(res) => console.log("A contact address is copied")
		)
		.catch(
			(err) => console.log("Something went wrong")
		);
	e.target.innerHTML = "A contact address is copied";
	setTimeout(function(){ e.target.innerHTML = "Copy a contact address"; }, 3000);
})